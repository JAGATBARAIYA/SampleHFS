...
- (void)viewDidLoad {
    ...
    _menuView.itemIndicatorColor = [UIColor colorWithRed:170.0/255.0 green:147.0/255.0 blue:98.0/255.0 alpha:1.0];//self.menuIndicatorColor;
...
- (void)scrollToViewAtIndex:(NSInteger)index {
    ...
    [_menuView setIndicatorViewFrameWithRatio:index isNextItem:YES toIndex:index];
}
