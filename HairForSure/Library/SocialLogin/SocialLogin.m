...
-(void)setLoginType:(LoginType)loginType{
    ...
    _accountType = [_accountStore accountTypeWithAccountTypeIdentifier:((loginType == kLoginTypeFacebook)?ACAccountTypeIdentifierFacebook:ACAccountTypeIdentifierTwitter)];
}
