...
#define kTimeFormat                             @"MMM dd, yyyy hhmmss"
...
#define titleFail                               @"No internet connnection available."
...
#define msgUpdateTitle                          @"Update Available"
#define msgUpdateDesc                           @"A new version of Hair For Sure is available. Please update to version %@ now."
