...
- (id)initWithView:(UIView *)view withDarkTheme:(BOOL)isDarkTheme{
    self = [super initWithFrame:CGRectMake(20, 64, view.bounds.size.width-40, view.bounds.size.height-64)];
    if (self) {
        self.opaque = NO;
        ...
        UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(25, 150, 230, 230)];
        imageView.image = [UIImage imageNamed:@"time_pickr"];
        [self addSubview:imageView];
        
        UIView *headerView = [[UIView alloc]initWithFrame:CGRectMake(0, 95, 280, 40)];
        headerView.backgroundColor = [UIColor colorWithRed:16.0/255.0 green:39.0/255.0 blue:73.0/255.0 alpha:1.0];
        [self addSubview:headerView];
        
        UILabel *lblTitle = [[UILabel alloc]initWithFrame:CGRectMake(100, 0, 100, 40)];
        lblTitle.font = [UIFont fontWithName:@"Roboto-Bold" size:16.0];
...
-(void)createClockView{
    ...
    doneButton = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width/2 - 50, lineView.frame.origin.y +( self.frame.size.height-lineView.frame.origin.y)/2-25, 100, 40)];
    [doneButton setTitle:@"DONE" forState:UIControlStateNormal];
    [doneButton setBackgroundColor:[UIColor colorWithRed:170.0/255.0 green:147.0/255.0 blue:98.0/255.0 alpha:10.]];
    [doneButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [doneButton.titleLabel setFont:[UIFont fontWithName:@"Roboto-Bold" size:17.0]];
