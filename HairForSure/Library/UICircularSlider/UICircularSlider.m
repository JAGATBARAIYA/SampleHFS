...
- (void)setup {
	...
	self.maximumValue = 720.0;
	self.minimumTrackTintColor = [UIColor colorWithRed:170.0/255.0 green:147.0/255.0 blue:98.0/255.0 alpha:1.0];
	self.maximumTrackTintColor = [UIColor whiteColor];
	self.thumbTintColor = [UIColor colorWithRed:170.0/255.0 green:147.0/255.0 blue:98.0/255.0 alpha:1.0];
	self.continuous = YES;
